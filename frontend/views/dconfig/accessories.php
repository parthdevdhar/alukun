        ...
        <div class="wrap-block">
            <div class="sidebar">
                <div class="filter-block">
                    <div class="filter-box">
                        <div class="filter-title"><a href="javascript:void(0);" data-toggle="collapse" data-target="#outside-handle" aria-expanded="true" aria-controls="outside-handle">outside handle</a></div>
                        <div class="collapse show" id="outside-handle">
                            <div class="img-box">
                                <img src="<?= Url::home(true); ?>theme/images/outside-handle.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="filter-box">
                        <div class="filter-title"><a href="javascript:void(0);" data-toggle="collapse" data-target="#inside-push" aria-expanded="true" aria-controls="inside-push">inside push</a></div>
                        <div class="collapse show" id="inside-push">
                            <div class="img-box">
                                <img src="<?= Url::home(true); ?>theme/images/inside-push.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="filter-box">
                        <div class="filter-title"><a href="javascript:void(0);" data-toggle="collapse" data-target="#lock" aria-expanded="true" aria-controls="lock">Lock</a></div>
                        <div class="collapse show" id="lock">
                            <div class="img-box">
                                <img src="<?= Url::home(true); ?>theme/images/lock.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="main-content">
                <ul class="select-process">
                    <li><a href="choose-model.html">Choose Model</a></li>
                    <li><a href="javascript:void(0);">Door type and dimensions</a></li>
                    <li><a href="<?= Url::to(['//dconfig/colour', 'id' => $_GET['id']]) ?>">Colours</a></li>
                    <li class="active"><a href="<?= Url::to(['//dconfig/accessories', 'id' => $_GET['id']]) ?>">Accessories</a></li>
                </ul>
                <div class="panel-box">
                    <div class="panel-bx">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="door-sketcher" viewBox="0 0 1160 2130" width="129.6150234741784px" height="238px" style="margin-left: -64.8075px;"><svg id="Vrata" x="30" y="30">
                                            ...
                                            <g>
                                                ...
                                                <g transform="translate(69,69)" id="KriloDodatki">
                                                    ...
                                                    <g transform="translate(14,1052) rotate(0,21,21)">
                                                        <image x="0" y="0" height="42" width="42" xlink:href="https://doordesigner.inotherm.com/konfigurator/<?= Url::home(true); ?>theme/images//Zubehor/Rosette_aussen/ZRE_46.png"></image>
                                                    </g>
                                                    <g transform="translate(95,625)  rotate(0,15,387)">
                                                        <image x="0" y="0" height="774" width="56" preserveAspectRatio="none" xlink:href="https://doordesigner.inotherm.com/konfigurator/<?= Url::home(true); ?>theme/images//Zubehor/Griffe-Drucker/Edelstahl/ZAE_70/ZAE_72.png"></image>
                                                    </g>
                                                </g>
                                            </g>
                                        </svg>
                            ...
                            <defs id="defs">
                                <pattern id="OKVIR_KRILA_HORIZONTAL" x="0" y="0" height="100" width="100" patternUnits="userSpaceOnUse" patternTransform="rotate(90) ">
                                    <image x="0" y="0" height="100" width="100" preserveAspectRatio="none" xlink:href="https://doordesigner.inotherm.com/konfigurator/<?= Url::home(true); ?>theme/images/colors/colorServlet?R=55&amp;G=51&amp;B=50"></image>
                                </pattern>
                                ...
                                <pattern id="DYNAMIC309141" x="0" y="0" height="2600" width="2600" patternUnits="userSpaceOnUse">
                                    <image x="0" y="0" height="2600" width="2600" preserveAspectRatio="none" xlink:href="https://doordesigner.inotherm.com/konfigurator/<?= Url::home(true); ?>theme/images/textures/EDELSTAHL_MATT.jpg"></image>
                                </pattern>
