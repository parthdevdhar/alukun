...
<head>
    ...
    <link href="<?php echo Url::home(true); ?>theme/css/custom.css" rel="stylesheet">
...
<body class="login-register-bg">
    <main class="main">
        ...
        <div class="login-register">
            <div class="logo" onclick="location.href='<?= Url::home(true); ?>'" style="cursor: pointer;"><img src="<?= Url::home(true); ?>theme/images/logo.png" alt="" style="width: 350px;"></div>
            <?= $content ?>
        </div>
        <!-- =================  Login End ================ -->
    </main>
