...
<head>
    ...
    <link rel="stylesheet" href="<?= Url::home(true); ?>theme/assets/examples/css/pages/login-v3.css">
...
<body class="animsition page-login-v3 layout-full">
    ...
    <script src="<?= Url::home(true); ?>theme/global/vendor/jquery-placeholder/jquery.placeholder.js"></script>
    ...
    <script src="<?= Url::home(true); ?>theme/global/js/Plugin/jquery-placeholder.js"></script>
    <script src="<?= Url::home(true); ?>theme/global/js/Plugin/material.js"></script>
